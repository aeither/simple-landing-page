...
const componentsByPath = {
    ...
    "home": {name: "Home", projectId: "9xJG4KN5rLUh22CtRoJihu" },
  
    "pricing": {name: "Pricing", projectId: "9xJG4KN5rLUh22CtRoJihu" },
  
    "features": {name: "Features", projectId: "9xJG4KN5rLUh22CtRoJihu" },
